...
// This code modified by M. Bogner August 2012 for the 3.0 CP upgrade project
                           int tempSDI = (int) getSDI("input");
			  rbu.merge_cp_hist_calc(comp.getAppId(),tempSDI,input_interval,_aggregatePeriodBegin,
//rbu.merge_cp_hist_calc(comp.getAppId().intValue(),getSDI("input"),input_interval,_aggregatePeriodBegin,
