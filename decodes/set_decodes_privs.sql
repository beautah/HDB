...
/* the public synonyms where added 12/13/06 by M. BOgner after A. Gilmore found these to be missing   */
create public  synonym platformconfigidseq for decodes.platformconfigidseq;
create public  synonym datatypeidseq for decodes.datatypeidseq;
create public  synonym EnumIdSeq for decodes.ENUMIDSEQ;
create public  synonym EquipmentIdSeq for decodes.EQUIPMENTIDSEQ ;
create public  synonym PlatformIdSeq for decodes.PLATFORMIDSEQ ;
create public  synonym DecodesScriptIdSeq for decodes.DECODESSCRIPTIDSEQ;
create public  synonym RoutingSpecIdSeq for decodes.ROUTINGSPECIDSEQ;
create public  synonym DataSourceIdSeq for decodes.DATASOURCEIDSEQ;
create public  synonym NetworkListIdSeq for decodes.NETWORKLISTIDSEQ;
create public  synonym PresentationGroupIdSeq for decodes.PRESENTATIONGROUPIDSEQ;
create public  synonym DataPresentationIdSeq for decodes.DATAPRESENTATIONIDSEQ;
create public  synonym UnitConverterIdSeq for decodes.UNITCONVERTERIDSEQ;
