/* inorder to import decodes metadata these two views mush be disabled
the are being disabled by the and 1=2 logic  */
...
and a.hdb_site_id = c.site_id and c.db_site_code = d.db_site_code and d.session_no = 1 and 1=2;
