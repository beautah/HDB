...
{12,4130,1,0,0,
5,0,0,1,238,0,1028,64,0,0,10,1,0,0,128,2,97,0,0,2,3,0,0,2,3,0,0,2,97,0,0,2,97,
...

{
   ...
   sqlstm.stmt = "select unit_name ,dimension_id ,base_unit_id ,month_year ,\
over_month_year ,is_factor ,mult_factor ,from_stored_expression ,to_stored_exp\
ression into :b1,:b2,:b3,:b4:b5,:b6:b7,:b8,:b9:b10,:b11:b12,:b13:b14  from hdb\
_unit where unit_id=:b15";
