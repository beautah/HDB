...
//
                ...
                if (total_count == 0)
                {
		   debug3(" EndofPeriodALg: No records found for this period: " + _aggregatePeriodEnd + "  SDI: " + getSDI("input"));
                   deleteOutput(output);
                   return;
                }

                debug3("EndofPeriodALg:"+"  aggLowerBoundClosed: " + aggLowerBoundClosed + "  aggUpperBoundClosed: " + aggUpperBoundClosed );
                debug3("EndofPeriodALg:"+"  aggregatePeriodBegin: " + _aggregatePeriodBegin + "  aggregatePeriodEnd: " + _aggregatePeriodEnd );
                debug3(" EndofPeriodALg: Last found for this period: " + date_out + "  SDI: " + getSDI("input"));
		...
		{
		 do_setoutput = false;
		debug1(" EndofPeriodALg: OUTPUT FALSE DUE to Window exceeded: " + _aggregatePeriodEnd + "  SDI: " + getSDI("input"));
		}
