...
//AW:PROPERTIES
	...
	"validation_flag", "observations_calculation", "flow_factor" };
//AW:PROPERTIES_END
...
//
		...
		DataObject dbobj = new DataObject();
                ...
                Integer sdi = new Integer( getSDI("input"));
		...
		if (do_setoutput) 
		{
		   ...
		   if (total_count < mvd_count) flags = flags + "n";
                   ...
                   //  now we have a partial calculation, so do what needs to be done for partials
                   {
                      ...
                      rbu.merge_cp_hist_calc(comp.getAppId(),getSDI("input"),input_interval,_aggregatePeriodBegin,
